...
> Status: CURRENT. This index is the navigation entrypoint for Aquagenesys documentation.

## Current Guidance

- `CODEX_STANDARDS.md` - repo-local Codex standards contract.
- `decisions/` - chronological architecture decision records.
